...
function Save() {
  ...
  document.querySelector("#lbl-name").textContent='name: '+user.name;
  document.querySelector("#lbl-date").textContent='birthDate: '+user.birthDate;
  document.querySelector("#lbl-weight").textContent='weight: '+user.weight;
  document.querySelector("#lbl-height").textContent='height: '+user.height;
  document.querySelector("#lbl-gender").textContent='gender: '+user.gender;
